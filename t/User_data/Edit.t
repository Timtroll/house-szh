...
my $test_data = {
    ...
    2 => {
        ...
        'result' => {
            'message'   => "Could not get user_data '404'",
            'status'    => 'fail'
        },
        'comment' => 'Wrong id:' 
    },
    3 => {
        'result' => {
            'message'   => "/user_data/edit _check_fields: didn't has required data in 'id' = ''",
            'status'    => 'fail'
        },
        'comment' => 'No data:' 
    },
    4 => {
        ...
        'result' => {
            'message'   => "/user_data/edit _check_fields: empty field 'id', didn't match regular expression",
            'status'    => 'fail'
        },
...
foreach my $test (sort {$a <=> $b} keys %{$test_data}) {
    ...
    $t->post_ok($host.'/user_data/edit' => {token => $token} => form => $data )
        ->status_is(200)
